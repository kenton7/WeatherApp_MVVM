...
extension MainViewController: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        let coordinates = CoordinatesNew(latitude: locValue.latitude, longitude: locValue.longitude)
...
//        self.coordinates = Coordinates(latitude: locValue.latitude, longitude: locValue.longitude)
//        let encodedCoordinates = try! JSONEncoder().encode([coordinates])
//        UserDefaults.standard.set(encodedCoordinates, forKey: "coordinates")
